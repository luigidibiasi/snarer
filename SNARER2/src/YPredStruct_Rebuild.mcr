...
macrotarget = 'C:\Users\Utente\Desktop\' 
MakeTab 1,Dimensions=1

for id in file (Macrotarget)\lista_pdb.txt ### Insert 1 pdb filename for each line 
  delobj all
